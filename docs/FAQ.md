...
wpstaging register
```
This will prompt you to enter your license key, validate it with WP STAGING servers, and store it encrypted locally for future use.
...
**A52:**
The CLI blocks root/administrator execution by default as a security best practice.

**Why running as root creates issues:**
...
3. **Updates browser trust stores:**
   ...
   - **macOS:** Firefox certificate store (if installed)
...
2. The tool installs the mkcert CA to your system trust store
3. On Linux, also installs to Chrome's NSS database automatically
...
**A67:**
Use the `list` command to view detailed status of all sites or a specific site:
...
**Summary Totals:**
The list command shows totals for: Total sites, Running, Stopped, Disabled (if any), and Missing (if any).
...
**Last Updated:** 2025-11-24 14:59:19 UTC
