...
- Docker Compose V1 (standalone `docker-compose`) is NOT supported
...
| `~/.wpstaging/data/mariadb/` | Database data | Varies |
| `~/.wpstaging/data/mkcert/ca/` | SSL certificates | <1 MB |
| `~/.wpstaging/docker/` | Service configs | <20 MB |
...
**Last Updated:** 2025-11-24 15:50:32 UTC
